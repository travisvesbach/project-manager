...
class ProjectsController extends Controller
{
    ...
    public function store() {
        ...
        return redirect($project->path())->with(['flash_message' => $project->name . ' created', 'flash_status' => 'success']);
    }
    ...
    public function update(Project $project) {
        ...
        return redirect($project->path())->with(['flash_message' => $project->name . ' updated', 'flash_status' => 'success']);
    }
    ...
    public function destroy(Project $project) {
        ...
        return redirect('/projects')->with(['flash_message' => $project->name . ' deleted', 'flash_status' => 'danger']);
    }
}
